defmodule VsoiWeb.CoreComponents do
  @moduledoc """
  ...
  # SCOTTWAS import VsoiWeb.Gettext
  use Gettext, backend: VsoiWeb.Gettext
  ...
  @doc """
  Renders a emoji local with class
  """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(VsoiWeb.Gettext, "errors", msg, msg, count, opts)
    else
